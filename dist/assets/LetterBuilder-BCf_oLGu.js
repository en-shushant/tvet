const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/jspdf.es.min-DR_f-tTu.js","assets/index-BorS74z0.js","assets/vendor-tAaa2TlE.js","assets/index-CTfNwfHc.css"])))=>i.map(i=>d[i]);
import{t as R,a as ne,j as i,B as J,_ as X,l as Z}from"./index-BorS74z0.js";import{r as b}from"./vendor-tAaa2TlE.js";function Q(){const t=new Date;let l=2e3,c=0,o=new Date(1943,3,14);for(let m=2e3;m<=2090;m++){const f=(Z[m]||[]).reduce((r,_)=>r+_,0),g=new Date(o.getTime()+f*864e5);if(g>t){l=m,c=Math.floor((t-o)/864e5);break}o=g}const p=Z[l]||[];let y=1,e=c+1;for(let m=0;m<p.length;m++){if(e<=p[m]){y=m+1;break}e-=p[m]}return`${R(l)}/${R(String(y).padStart(2,"0"))}/${R(String(e).padStart(2,"0"))}`}async function V(t){if(!t)return null;if(t.startsWith("data:"))return t;try{const l=await fetch(t);if(!l.ok)return t;const c=await l.blob();return new Promise(o=>{const p=new FileReader;p.onload=()=>o(p.result),p.onerror=()=>o(t),p.readAsDataURL(c)})}catch{return t}}async function le(t){return t?new Promise(l=>{const c=new Image;c.onload=()=>{try{const o=document.createElement("canvas");o.width=c.naturalWidth,o.height=c.naturalHeight;const p=o.getContext("2d");p.drawImage(c,0,0);const y=o.width,e=o.height,m=Math.max(1,Math.floor(y/30)),u=r=>{let _=0;for(let x=0;x<y;x+=m){const v=p.getImageData(x,r,1,1).data;v[3]>50&&(v[0]<220||v[1]<220||v[2]<220)&&_++}return _};let f=null;for(let r=Math.floor(e*.6);r>=0;r--)if(u(r)>=3){f=Math.ceil(r/e*297)+8;break}let g=null;for(let r=Math.floor(e*.6);r<e;r++)if(u(r)>=3){g=Math.ceil((e-r)/e*297)+8;break}l({top:f,bottom:g})}catch{l({top:null,bottom:null})}},c.onerror=()=>l({top:null,bottom:null}),c.src=t}):{top:null,bottom:null}}function w({fields:t,imgs:l,topMm:c,bottomMm:o,lrMm:p,inclSign:y,inclStamp:e,todayBSStr:m}){const{firmLetterhead:u,firmSign:f,firmStamp:g,firmName:r}=l,_=!!u,x=t.date||m,v=t.toTitle||"कार्यालय प्रमुख",E=t.toName||"",C=t.toName2||"",A=t.toAddress||"",I=t.fy||"",N=(t.body||"").replace(/\{fy\}/g,I),B=(t.bullets||"").split(`
`).filter(Boolean),S=t.sectionHeader||"",P=t.signatoryName||l.firmContactNp||"",L=t.firmNameNp||l.firmNameNp||r||"";return`<!DOCTYPE html><html lang="ne"><head><meta charset="UTF-8">
<style>
...
<div class="page"><div class="page-inner">
  ...
  <div class="body-txt">${N}</div>
  <div class="tapasil">तपसिल:</div>
  ${S?`<div class="sec-hdr">${S}</div>`:""}
  <ul class="bullets">
  ...
  <div class="sig-row">
    ...
    <div class="sig-block">
      ...
      <div class="sig-line">……………………………………<br>${P}<br>${L}</div>
    </div>
  </div>
...
समूह घ: आयोजना स्थलमा संचालन गर्नुपर्ने: Air, Noise, Water Quality मापन सम्बन्धी कार्य ।`}},fieldOrder:te,buildHtml:w}};function re({fields:t,row:l,imgs:c,topMm:o,bottomMm:p,lrMm:y,inclSign:e,inclStamp:m,todayBSStr:u}){const{firmLogo:f,firmLetterhead:g,firmSign:r,firmStamp:_,firmRegNo:x,firmPan:v,firmMeta:E,firmName:C}=c,A=!!g,I=t.date||u,N=t.ref||"",B=t.toName||l.toName||"",S=t.toAddress||l.toAddress||"",P=t.firmNameNp||c.firmNameNp||C||"",L=t.firmAcronym||c.firmAcronym||"",D=t.firmAddressNp||c.firmAddressNp||"",$=t.firmContact||c.firmContactNp||"",M=t.firmPhone||l.firmPhone||"",U=t.mobileNo||"",F=t.fy||l.fyNp||"",O=t.applicantName||$||"",W=t.sec1Header||"",Y=t.sec2Header||"",G=(t.sec2Items||"").split(`
...
<div class="page">
  ...
  <div class="ref-row">
    ${N?`<span>संख्या: ${N}</span>`:"<span></span>"}
    <span>मिति: ${I}</span>
  </div>
  <div class="to-block">
  ...
  <table>
    ...
    <tr>
      <td class="half">(ड) टेलिफोन नं: ${M?R(M):""}</td>
