const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/jspdf.es.min-CoC5eVB4.js","assets/index-CSVwYZDV.js","assets/vendor-tAaa2TlE.js","assets/index-DT88_xqd.css"])))=>i.map(i=>d[i]);
import{t as F,a as se,j as i,B as Z,_ as w,l as ee}from"./index-CSVwYZDV.js";import{r as f}from"./vendor-tAaa2TlE.js";import{l as oe}from"./Shortlisting-Cii6KnhI.js";function J(){const t=new Date;let s=2e3,o=0,g=new Date(1943,3,14);for(let d=2e3;d<=2090;d++){const p=(ee[d]||[]).reduce((y,N)=>y+N,0),v=new Date(g.getTime()+p*864e5);if(v>t){s=d,o=Math.floor((t-g)/864e5);break}g=v}const m=ee[s]||[];let S=1,e=o+1;for(let d=0;d<m.length;d++){if(e<=m[d]){S=d+1;break}e-=m[d]}return`${F(s)}/${F(String(S).padStart(2,"0"))}/${F(String(e).padStart(2,"0"))}`}async function Y(t){if(!t)return null;if(t.startsWith("data:"))return t;try{const s=await fetch(t);if(!s.ok)return t;const o=await s.blob();return new Promise(g=>{const m=new FileReader;m.onload=()=>g(m.result),m.onerror=()=>g(t),m.readAsDataURL(o)})}catch{return t}}async function re(t){return t?new Promise(s=>{const o=new Image;o.onload=()=>{try{const S=Math.min(1,794/o.naturalWidth,1123/o.naturalHeight),e=document.createElement("canvas");e.width=Math.round(o.naturalWidth*S),e.height=Math.round(o.naturalHeight*S);const d=e.getContext("2d");d.drawImage(o,0,0,e.width,e.height);const u=e.width,p=e.height,v=Math.max(1,Math.floor(u/30)),y=c=>{let P=0;for(let j=0;j<u;j+=v){const _=d.getImageData(j,c,1,1).data;_[3]>50&&(_[0]<220||_[1]<220||_[2]<220)&&P++}return P};let N=null;for(let c=Math.floor(p*.6);c>=0;c--)if(y(c)>=3){N=Math.ceil(c/p*297)+8;break}let A=null;for(let c=Math.floor(p*.6);c<p;c++)if(y(c)>=3){A=Math.ceil((p-c)/p*297)+8;break}s({top:N,bottom:A})}catch{s({top:null,bottom:null})}},o.onerror=()=>s({top:null,bottom:null}),o.src=t}):{top:null,bottom:null}}function te({fields:t,imgs:s,topMm:o,bottomMm:g,lrMm:m,inclSign:S,inclStamp:e,todayBSStr:d,kalimatiCss:u=""}){const{firmLetterhead:p,firmSign:v,firmStamp:y,firmName:N}=s,A=!!p,c=t.date||d,P=t.toTitle||"कार्यालय प्रमुख",j=t.toName||"",_=t.toName2||"",D=t.toAddress||"",T=t.fy||"",R=(t.body||"").replace(/\{fy\}/g,T),k=(t.bullets||"").split(`
`).filter(Boolean),C=t.sectionHeader||"",$=t.signatoryName||s.firmContactNp||"",H=t.firmNameNp||s.firmNameNp||N||"";return`<!DOCTYPE html><html lang="ne"><head><meta charset="UTF-8">
<style>${u}</style>
<style>
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  .page {
    ...
    ${A?`background-image:url("${p}");background-repeat:no-repeat;background-position:0 0;background-size:794px 1123px;`:""}
  }
  .page-inner { position:relative;z-index:1;padding:${o}mm ${m}mm ${g}mm ${m}mm; }
...
<div class="page"><div class="page-inner">
  ...
  <div class="ref-row"><span>मिति: ${c}</span></div>
  ...
  ${C?`<div class="sec-hdr">${C}</div>`:""}
  <ul class="bullets">
    ${k.map(M=>`<li>${M}</li>`).join(`
    `)}
  </ul>

  <div class="sig-row">
    <div class="sig-stamp">
      ${e&&y?`<img src="${y}" style="width:26mm;height:26mm;object-fit:contain;display:block;margin:0 auto;">`:""}
    </div>
    <div class="sig-block">
      ${S&&v?`<img src="${v}" style="display:block;margin:0 auto;max-height:14mm;max-width:100%;object-fit:contain;margin-bottom:4px;">`:""}
      <div class="sig-line">${$}<br>${H}</div>
    </div>
  </div>
...
समूह घ: आयोजना स्थलमा संचालन गर्नुपर्ने: Air, Noise, Water Quality मापन सम्बन्धी कार्य ।`}},fieldOrder:ie,buildHtml:te}};function pe({fields:t,row:s,imgs:o,topMm:g,bottomMm:m,lrMm:S,inclSign:e,inclStamp:d,todayBSStr:u,kalimatiCss:p=""}){const{firmLogo:v,firmLetterhead:y,firmSign:N,firmStamp:A,firmRegNo:c,firmPan:P,firmMeta:j,firmName:_}=o,D=!!y,T=t.date||u,R=t.ref||"",k=t.toName||s.toName||"",C=t.toAddress||s.toAddress||"",$=t.firmNameNp||o.firmNameNp||_||"",H=t.firmAcronym||o.firmAcronym||"",M=t.firmAddressNp||o.firmAddressNp||"",O=t.firmContact||o.firmContactNp||"",L=t.firmPhone||s.firmPhone||"",U=t.mobileNo||"",V=t.fy||s.fyNp||"",K=t.applicantName||O||"",W=t.sec1Header||"",G=t.sec2Header||"",q=(t.sec2Items||"").split(`
`).filter(Boolean),X=t.sec3Header||"",a=t.supplyLabel||"",n=t.supplyValue||"",r=t.constructionLabel||"",h=t.constructionValue||"",x=t.consultingLabel||"",I=t.otherServiceLabel||"",B=t.otherServiceValue||"",z=t.dateLabel||"",E=t.fyLabel||"",l=t.stampLabel||"",b=t.applicantLabel||"",Q=t.signLabel||"";return`<!DOCTYPE html><html lang="ne"><head><meta charset="UTF-8">
<style>${p}</style>
<style>
  * { margin:0; padding:0; box-sizing:border-box; }
  body { background:#fff; }
  .page {
    ...
    font-family:'Kalimati','Noto Sans Devanagari','Arial Unicode MS',sans-serif; font-size:13px;
    background-color:#fff;
    ${D?`/* longhand: html2canvas drops background-size from the shorthand */
    background-image:url("${y}");
    background-repeat:no-repeat;
    background-position:0 0;
    background-size:794px 1123px;`:""}
  }
  .page-inner { position:relative;z-index:1;padding:${g}mm ${S}mm ${m}mm ${S}mm; }
...
<div class="page">
  ...
  ${D?"":`
  ${c||P?`<div class="lh-regpan"><span>${c?"Govt. Regd.No. "+c:""}</span><span>${P?"PAN No. "+P:""}</span></div>`:""}
  <div class="lh-center">
    ${v?`<img src="${v}" class="lh-logo" alt="">`:""}
    <div class="lh-name">${$}${H&&H!==$?` (${H})`:""}</div>
    ${j?`<div class="lh-meta">${j}</div>`:""}
  </div>
  ...
  <table>
    ...
    <tr>
      <td class="half">(क) नाम: ${$}${H?" ("+H+")":""}</td>
      <td class="half">(ख) ठेगाना: ${M}</td>
    </tr>
    <tr>
      <td class="half">(ग) पत्राचार गर्ने ठेगाना: ${M}</td>
      <td class="half">(घ) मुख्य व्यक्तिको नाम: ${O}</td>
    </tr>
    <tr>
      <td class="half">(ड) टेलिफोन नं: ${L?F(L):""}</td>
    ...
    <tr><td colspan="2" style="padding:0;">
      <table style="width:100%;border-collapse:collapse;">
        ...
        <tr>
          ...
          <td class="w22" style="border:none;border-right:1px solid #666;padding:5px 8px;">${I}</td>
    ...
    <tr><td colspan="2" style="padding:0;">
      <div style="display:flex;min-height:100px;">
        ...
        <div style="flex:0 0 32%;border-right:1px solid #666;text-align:center;padding:6px 4px;">
          ${d&&A?`<div style="font-size:9pt;margin-bottom:3px;">${l}</div><img src="${A}" style="display:block;margin:0 auto;width:30mm;height:30mm;object-fit:contain;background:#fff;">`:""}
        </div>
...
</body></html>`}function fe({row:t,token:s,onClose:o,allRows:g}){const[m,S]=f.useState((t==null?void 0:t.id)??null),e=g&&m&&g.find(a=>a.id===m)||t,d=(e==null?void 0:e.list_letter_type)||(e==null?void 0:e.letter_type)||"basic",u=ne[d]||ne.basic,[p,v]=f.useState(()=>{const a=Object.fromEntries(Object.entries(u.fields).map(([n,r])=>[n,r.value]));return a.date=J(),a}),[y,N]=f.useState(!!(e!=null&&e.institute_sign)),[A,c]=f.useState(!!(e!=null&&e.institute_stamp)),[P,j]=f.useState(""),[_,D]=f.useState(null),[T,R]=f.useState(""),[k,C]=f.useState({top:null,bottom:null}),[$,H]=f.useState(!0),[M,O]=f.useState(!1),[L,U]=f.useState(null),V=f.useRef(null),K=f.useRef(null);f.useEffect(()=>()=>{L&&URL.revokeObjectURL(L)},[L]),f.useEffect(()=>{v(a=>{var n,r;return{...Object.fromEntries(Object.entries(u.fields).map(([h,x])=>[h,x.value])),date:a.date||J(),lrPadding:String((e==null?void 0:e.institute_letter_lr_padding)??20),toTitle:(e==null?void 0:e.list_addressee)||(e==null?void 0:e.client_signatory_position)||((n=u.fields.toTitle)==null?void 0:n.value)||"कार्यालय प्रमुख",toName:(e==null?void 0:e.client_name_manual)||(e==null?void 0:e.client_name_np)||(e==null?void 0:e.client_name)||"",toName2:(e==null?void 0:e.list_client_name2)||"",toAddress:(e==null?void 0:e.client_address_manual)||(e==null?void 0:e.client_address_np)||(e==null?void 0:e.client_address)||"",serviceType:(e==null?void 0:e.institute_service_type)||((r=u.fields.serviceType)==null?void 0:r.value)||"",firmNameNp:(e==null?void 0:e.institute_name_np)||(e==null?void 0:e.institute_name)||"",firmAcronym:(e==null?void 0:e.institute_acronym)||"",firmAddressNp:(e==null?void 0:e.institute_address_np)||(e==null?void 0:e.institute_address)||"",firmContact:(e==null?void 0:e.institute_contact_np)||(e==null?void 0:e.institute_contact)||"",firmPhone:(e==null?void 0:e.institute_phone)||"",fy:e!=null&&e.fy?F(e.fy):"",applicantName:(e==null?void 0:e.institute_contact_np)||(e==null?void 0:e.institute_contact)||"",signatoryName:(e==null?void 0:e.institute_contact_np)||(e==null?void 0:e.institute_contact)||""}})},[e==null?void 0:e.id,d]),f.useEffect(()=>{let a=!1;return(async()=>{H(!0);let n={};if(e!=null&&e.institute_id&&s)try{n=await se("GET",`/institutes/${e.institute_id}`,null,s)||{}}catch{}if(a)return;N(!!n.sign),c(!!n.stamp);const[r,h,x,I]=await Promise.all([Y(n.logo||(e==null?void 0:e.institute_logo)||null),Y(n.letterhead||(e==null?void 0:e.institute_letterhead)||null),Y(n.sign||(e==null?void 0:e.institute_sign)||null),Y(n.stamp||(e==null?void 0:e.institute_stamp)||null)]);if(a)return;const B=(e==null?void 0:e.institute_name)||"",z=(e==null?void 0:e.institute_address)||"",E=(e==null?void 0:e.institute_phone)||"",l=(e==null?void 0:e.institute_email)||"",b=(e==null?void 0:e.institute_website)||"";D({firmName:B,firmAcronym:(e==null?void 0:e.institute_acronym)||"",firmNameNp:(e==null?void 0:e.institute_name_np)||B,firmAddressNp:(e==null?void 0:e.institute_address_np)||z,firmContactNp:(e==null?void 0:e.institute_contact_np)||(e==null?void 0:e.institute_contact)||"",firmMeta:[z,E?`फोन: ${E}`:"",l,b].filter(Boolean).join("  |  "),firmRegNo:(e==null?void 0:e.institute_reg_no)||"",firmPan:(e==null?void 0:e.institute_pan)||"",firmPhone:E,firmLogo:r,firmLetterhead:h,firmSign:x,firmStamp:I}),oe().then(le=>{a||R(le)});const Q=await re(h);a||(C(Q),H(!1))})(),()=>{a=!0}},[e==null?void 0:e.id,e==null?void 0:e.institute_id,s]);const W=f.useCallback(()=>{if(!_)return"";const a=parseFloat(p.lrPadding)||(e==null?void 0:e.institute_letter_lr_padding)||20,n=(e==null?void 0:e.institute_letter_top_margin)??15,r=(e==null?void 0:e.institute_letter_bottom_padding)??15,h=k.top&&k.top>n?k.top:n,x=k.bottom&&k.bottom>r?k.bottom:r,I={toName:(e==null?void 0:e.client_name_manual)||(e==null?void 0:e.client_name_np)||(e==null?void 0:e.client_name)||"",toAddress:(e==null?void 0:e.client_address_manual)||(e==null?void 0:e.client_address_np)||(e==null?void 0:e.client_address)||"",firmPhone:(e==null?void 0:e.institute_phone)||"",fyNp:e!=null&&e.fy?F(e.fy):""};return u.buildHtml({fields:p,row:I,imgs:_,topMm:h,bottomMm:x,lrMm:a,inclSign:y,inclStamp:A,todayBSStr:J(),kalimatiCss:T})},[p,_,k,y,A,e,u,T]);f.useEffect(()=>{$||j(W())},[$,W]);const G=async()=>{O(!0);try{const r=document.createElement("iframe");r.style.cssText="position:fixed;left:-9999px;top:0;width:794px;height:1123px;border:none;visibility:hidden;",document.body.appendChild(r),await new Promise(l=>{r.onload=l,r.srcdoc=W()});const h=r.contentDocument;await Promise.all([...h.querySelectorAll("img")].map(l=>l.complete?Promise.resolve():new Promise(b=>{l.onload=b,l.onerror=b})));const x=h.querySelector(".page-inner");if(x){const l=h.querySelector(".sig-row");if(l&&x.scrollHeight>1113){let b=72;for(;x.scrollHeight>1113&&b>8;)b=Math.max(8,b-8),l.style.marginTop=`${b}px`}if(x.scrollHeight>1113){const b=Math.max(.5,1113/x.scrollHeight);x.style.transformOrigin="top left",x.style.transform=`scale(${b})`,x.style.width=`${Math.round(100/b)}%`}}const{default:I}=await w(async()=>{const{default:l}=await import("./html2canvas.esm-CBrSDip1.js");return{default:l}},[]),{jsPDF:B}=await w(async()=>{const{jsPDF:l}=await import("./jspdf.es.min-CoC5eVB4.js").then(b=>b.j);return{jsPDF:l}},__vite__mapDeps([0,1,2,3])),z=new B({unit:"mm",format:"a4",orientation:"portrait"}),E=h.querySelectorAll(".page");for(let l=0;l<E.length;l++){const b=await I(E[l],{scale:2,useCORS:!0,allowTaint:!0,backgroundColor:"#fff",width:794,height:1123,windowWidth:794,windowHeight:1123});l>0&&z.addPage(),z.addImage(b.toDataURL("image/jpeg",.95),"JPEG",0,0,210,297)}document.body.removeChild(r),U(l=>(l&&URL.revokeObjectURL(l),z.output("bloburl")))}finally{O(!1)}},q=()=>{var a;try{const n=(a=K.current)==null?void 0:a.contentWindow;if(n){n.focus(),n.print();return}}catch{}L&&window.open(L,"_blank","noopener")},X=u.fieldOrder.filter(a=>u.fields[a]);return i.jsxs("div",{style:{position:"fixed",inset:0,background:"rgba(0,0,0,.55)",zIndex:1200,display:"flex",flexDirection:"column"},children:[i.jsxs("div",{style:{display:"flex",alignItems:"center",gap:12,padding:"10px 20px",background:"var(--surface)",borderBottom:"1px solid var(--border)",flexShrink:0},children:[i.jsx("div",{style:{fontWeight:700,fontSize:16,color:"var(--text)"},children:"Letter Builder"}),i.jsx("div",{style:{fontSize:12,color:"var(--text3)",padding:"3px 10px",borderRadius:100,background:"var(--bg)",border:"1px solid var(--border)"},children:u.name}),g&&g.length>0&&i.jsxs("select",{value:m??"",onChange:a=>S(Number(a.target.value)),style:{padding:"6px 10px",borderRadius:8,border:"1px solid var(--border)",background:"var(--surface)",color:"var(--text)",fontSize:13,fontFamily:"inherit",flex:1,maxWidth:280,cursor:"pointer"},children:[i.jsx("option",{value:"",children:"— Select firm —"}),g.map(a=>i.jsxs("option",{value:a.id,children:[a.institute_name,a.client_short?` → ${a.client_short}`:""]},a.id))]}),i.jsxs("div",{style:{display:"flex",gap:8,marginLeft:"auto"},children:[i.jsxs("label",{style:{display:"flex",alignItems:"center",gap:6,fontSize:12,cursor:"pointer",color:"var(--text2)"},children:[i.jsx("input",{type:"checkbox",checked:A,onChange:a=>c(a.target.checked),style:{accentColor:"var(--primary)"}})," छाप"]}),i.jsxs("label",{style:{display:"flex",alignItems:"center",gap:6,fontSize:12,cursor:"pointer",color:"var(--text2)"},children:[i.jsx("input",{type:"checkbox",checked:y,onChange:a=>N(a.target.checked),style:{accentColor:"var(--primary)"}})," हस्ताक्षर"]})]}),i.jsx(Z,{className:"btn btn-primary",onClick:G,disabled:$||M,style:{minWidth:130,fontSize:13},children:M?"Generating…":"Generate PDF"}),i.jsx("button",{onClick:o,style:{background:"none",border:"none",cursor:"pointer",fontSize:22,lineHeight:1,color:"var(--text3)",padding:"0 4px"},children:"×"})]}),i.jsxs("div",{style:{display:"flex",flex:1,overflow:"hidden"},children:[i.jsxs("div",{style:{width:340,flexShrink:0,overflowY:"auto",padding:20,borderRight:"1px solid var(--border)",background:"var(--bg)",display:"flex",flexDirection:"column",gap:14},children:[$&&i.jsx("div",{style:{color:"var(--text3)",fontSize:13},children:"Loading images…"}),!$&&X.map(a=>{const n=u.fields[a];return i.jsxs("div",{children:[i.jsx("div",{style:{fontSize:11,fontWeight:600,color:"var(--text3)",marginBottom:4,textTransform:"uppercase",letterSpacing:.5},children:n.label}),n.multiline?i.jsx("textarea",{value:p[a]??"",onChange:r=>v(h=>({...h,[a]:r.target.value})),rows:3,style:{width:"100%",padding:"8px 10px",border:"1px solid var(--border)",borderRadius:6,fontSize:13,fontFamily:"Kalimati,Noto Sans Devanagari,Arial Unicode MS,sans-serif",resize:"vertical",background:"var(--surface)",color:"var(--text)",outline:"none",lineHeight:1.7}}):i.jsx("input",{value:p[a]??"",onChange:r=>v(h=>({...h,[a]:r.target.value})),style:{width:"100%",padding:"8px 10px",border:"1px solid var(--border)",borderRadius:6,fontSize:13,fontFamily:"Kalimati,Noto Sans Devanagari,Arial Unicode MS,sans-serif",background:"var(--surface)",color:"var(--text)",outline:"none"}})]},a)})]}),i.jsx("div",{style:{flex:1,overflow:"auto",background:"#666",display:"flex",alignItems:"flex-start",justifyContent:"center",padding:24},children:$?i.jsx("div",{style:{color:"#fff",fontSize:14,marginTop:60},children:"Loading…"}):i.jsx("iframe",{ref:V,srcDoc:P,style:{width:794,height:1123,border:"none",boxShadow:"0 4px 24px rgba(0,0,0,.4)",background:"#fff",flexShrink:0},title:"Letter Preview"})})]}),L&&i.jsxs("div",{style:{position:"fixed",inset:0,background:"rgba(0,0,0,.65)",zIndex:1400,display:"flex",flexDirection:"column"},children:[i.jsxs("div",{style:{display:"flex",alignItems:"center",gap:10,padding:"10px 20px",background:"var(--surface)",borderBottom:"1px solid var(--border)",flexShrink:0},children:[i.jsx("div",{style:{fontWeight:700,fontSize:16,color:"var(--text)"},children:"Letter Preview"}),i.jsxs("div",{style:{marginLeft:"auto",display:"flex",gap:8,alignItems:"center"},children:[i.jsxs(Z,{className:"btn btn-secondary",onClick:q,children:[i.jsx("span",{className:"material-icons-round",style:{fontSize:16},children:"print"})," Print"]}),i.jsxs("a",{href:L,download:"shortlist-letter.pdf",className:"btn btn-primary",style:{textDecoration:"none",display:"inline-flex",alignItems:"center",gap:6},children:[i.jsx("span",{className:"material-icons-round",style:{fontSize:16},children:"download"})," Download"]}),i.jsx("button",{onClick:()=>{URL.revokeObjectURL(L),U(null)},style:{background:"none",border:"none",cursor:"pointer",fontSize:22,lineHeight:1,color:"var(--text3)",padding:"0 4px"},children:"×"})]})]}),i.jsx("iframe",{ref:K,src:L,title:"Letter PDF preview",style:{flex:1,border:"none",background:"#666",width:"100%"}})]})]})}export{fe as default};
