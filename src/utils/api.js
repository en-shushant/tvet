...
export function normInst(r) {
  return {
    ...
    sign: r.sign || null,
    stamp: r.stamp || null,
    ocrRegistration: r.ocr_registration || null,
    ocrRenewal: r.ocr_renewal || null,
    localLevelRegistration: r.local_level_registration || null,
    localLevelRenewal: r.local_level_renewal || null,
    vatRegistration: r.vat_registration || null,
    vatExtension: r.vat_extension || null,
    ctevtAffiliation: r.ctevt_affiliation || null,
    ctevtRenewal: r.ctevt_renewal || null,
    website: r.website || '',
...
export function instToAPI(f) {
  return {
    ...
    contact_person: f.contactPerson, phone: f.phone, mobile: f.mobile || null,
    ...
    sign: f.sign || null,
    stamp: f.stamp || null,
    ocr_registration: f.ocrRegistration || null,
    ocr_renewal: f.ocrRenewal || null,
    local_level_registration: f.localLevelRegistration || null,
    local_level_renewal: f.localLevelRenewal || null,
    vat_registration: f.vatRegistration || null,
    vat_extension: f.vatExtension || null,
    ctevt_affiliation: f.ctevtAffiliation || null,
    ctevt_renewal: f.ctevtRenewal || null,
